        ...
        if ($action === 'add') {
            ...
            if (empty($title)) {
                ...
                try {
                    ...
                    logActivity('Book added', $_SESSION['admin_id'], 'books', 'INSERT', $bookId);
        ...
        elseif ($action === 'update') {
            ...
            if (empty($title)) {
                ...
                try {
                    ...
                    logActivity('Book updated', $_SESSION['admin_id'], 'books', 'UPDATE', $bookId);
        ...
        elseif ($action === 'delete') {
            ...
            try {
                ...
                if ($activeBorrowings > 0) {
                    ...
                    logActivity('Book deleted', $_SESSION['admin_id'], 'books', 'DELETE', $bookId);
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="index.php?page=books&action=edit&id=<?php echo $book['book_id']; ?>" class="btn btn-primary" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="index.php?page=books&action=delete&id=<?php echo $book['book_id']; ?>" class="btn btn-danger" title="Delete">
