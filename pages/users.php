...
$query = "SELECT u.*, a.name, a.nim FROM users u JOIN anggota a ON u.anggota_id = a.anggota_id WHERE u.role = 'user'";
$countQuery = "SELECT COUNT(*) as total FROM users u JOIN anggota a ON u.anggota_id = a.anggota_id WHERE u.role = 'user'";
$params = [];
